...
/* Saves type of Wall
0   - WL_ERASE (No Wall)
1   - WL_WALL (Simple Wall)
2   - WL_DESTROYALL (Absorbs all)
3   - WL_ALLOWLIQUID (Liquids only)
4   - WL_FAN (Fan)
5   - WL_STREAM (Streamline)
6   - WL_DETECT (Detector)
7   - WL_EWALL (E-Wall)
8   - WL_WALLELEC (Conductive Wall)
9   - WL_ALLOWAIR (Air only)
10  - WL_ALLOWSOLID (Solids only)
11  - WL_ALLOWALLELEC (Conductor)
12  - WL_EHOLE (E-Hole)
13  - WL_ALLOWGAS (Gases only)
255 - ??
*/

extern unsigned char emap[YRES/CELL][XRES/CELL];
// Saves electricity state of Wall
