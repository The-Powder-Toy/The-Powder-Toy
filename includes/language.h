...
char *beta_hud_text = "Me's Mod version %d.%d Beta %d FPS:%d Parts:%d Gen:%d Grav:%d Air:%d";
...
char *beta_hud_text = "Me's Mod versi %d.%d Beta %d FPS:%d Bagian:%d Gen:%d Grav:%d Udara:%d";
