...
public:
	...
	static int update(UPDATE_FUNC_ARGS);
	static int graphics(GRAPHICS_FUNC_ARGS);
	static void transfer_pipe_to_part(Particle *pipe, Particle *part);
...
class Element_FELE: public Element
{
public:
	Element_FELE();
	virtual ~Element_FELE();
	static int update(UPDATE_FUNC_ARGS);
	static int graphics(GRAPHICS_FUNC_ARGS);
};
...
class Element_LIND: public Element
{
public:
	Element_LIND();
	virtual ~Element_LIND();
