...
echo Compiling
gcc -Wall -g -m32 -std=c99 -D_POSIX_C_SOURCE=200112L -O3 -ffast-math -ftree-vectorize -funsafe-math-optimizations %ARCH% %SSE% %MMX% -DX86 -mwindows -DWIN32 -oPowder -Iincludes src/*.c src/renderer/sw.c powder-res.o -lmingw32 -lSDL.dll -lSDLmain -lSDL -lbz2 -lwsock32 -lws2_32
