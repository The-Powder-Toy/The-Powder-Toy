...
std::vector<Element> GetElements()
{
	...
	elements.push_back(Element_TUGN());
	elements.push_back(Element_TUNG());
	elements.push_back(Element_PSNS());
	elements.push_back(Element_RBTY());
	elements.push_back(Element_3H2O());
	elements.push_back(Element_ALCO());
	elements.push_back(Element_ALMN());
	elements.push_back(Element_ALPH());
	elements.push_back(Element_AQRG());
	elements.push_back(Element_ASPK());
	elements.push_back(Element_BARI());
	elements.push_back(Element_BEEP());
	elements.push_back(Element_BOX());
	...
	elements.push_back(Element_DQRK());
	elements.push_back(Element_DTRM());
	elements.push_back(Element_FELE());
	elements.push_back(Element_GIND());
	elements.push_back(Element_GLUON());
	elements.push_back(Element_GRID());
	elements.push_back(Element_GVTN());
	elements.push_back(Element_HDRN());
	elements.push_back(Element_HELI());
	elements.push_back(Element_HLM3());
	elements.push_back(Element_LIND());
	elements.push_back(Element_LRVS());
	elements.push_back(Element_MCLX());
	elements.push_back(Element_METR());
	elements.push_back(Element_N2());
	elements.push_back(Element_NEGP());
	elements.push_back(Element_NTGN());
	elements.push_back(Element_NTNO());
	elements.push_back(Element_OTWI());
	elements.push_back(Element_PHOS());
	elements.push_back(Element_PIND());
	elements.push_back(Element_PLGN());
	elements.push_back(Element_PROT());
	elements.push_back(Element_PRPC());
	elements.push_back(Element_PTRN());
	elements.push_back(Element_RBBR());
	elements.push_back(Element_REXP());
	elements.push_back(Element_RVRS());
	elements.push_back(Element_SDST());
	elements.push_back(Element_SEED());
	elements.push_back(Element_STAR());
	elements.push_back(Element_TRIT());
	elements.push_back(Element_UQRK());
	return elements;
}
