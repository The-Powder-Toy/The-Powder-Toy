...
powder-sse3.exe: $(SOURCES) powder-res.o
	$(PYCOMMAND)
	$(WIN_COMPILER) -o$@ $(CFLAGS_WIN32) $(OFLAGS) $(MFLAGS_SSE3) $(SOURCES) powder-res.o -lm -lmingw32 -lregex -lws2_32 -lSDLmain $(LFLAGS_WIN32) -mwindows -DWIN32
	strip $@
	chmod 0644 $@
	mv $@ build
...
powder-sse2.exe: $(SOURCES) powder-res.o
	$(PYCOMMAND)
	$(WIN_COMPILER) -o$@ $(CFLAGS_WIN32) $(OFLAGS) $(MFLAGS_SSE2) $(SOURCES) powder-res.o -lm -lmingw32 -lregex -lws2_32 -lSDLmain $(LFLAGS_WIN32) -mwindows -DWIN32 -ggdb
	strip $@
	chmod 0644 $@
	mv $@ build
...
powder-sse.exe: $(SOURCES) powder-res.o
	$(PYCOMMAND)
	$(WIN_COMPILER) -o$@ $(CFLAGS_WIN32) $(OFLAGS) $(MFLAGS_SSE) $(SOURCES) powder-res.o -lm -lmingw32 -lregex -lws2_32 -lSDLmain $(LFLAGS_WIN32) -mwindows -DWIN32
	strip $@
	chmod 0644 $@
	mv $@ build
