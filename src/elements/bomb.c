						...
						for (nxj=-rad; nxj<=rad; nxj++)
							for (nxi=-rad; nxi<=rad; nxi++)
								if ((pow(nxi,2))/(pow(rad,2))+(pow(nxj,2))/(pow(rad,2))<=1)
									if ((pmap[y+nxj][x+nxi]&0xFF)!=PT_DMND && (pmap[y+nxj][x+nxi]&0xFF)!=PT_CLNE && (pmap[y+nxj][x+nxi]&0xFF)!=PT_PCLN && (pmap[y+nxj][x+nxi]&0xFF)!=PT_BSHL && (pmap[y+nxj][x+nxi]&0xFF)!=PT_LQCL && (pmap[y+nxj][x+nxi]&0xFF)!=PT_GSCL && (pmap[y+nxj][x+nxi]&0xFF)!=PT_PDCL && (pmap[y+nxj][x+nxi]&0xFF)!=PT_BCLN) {
