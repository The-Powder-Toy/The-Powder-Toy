                ...
                if (x+rx>=0 && y+ry>0 && x+rx<XRES && y+ry<YRES && (rx || ry)){
                    ...
                    if (parts[r>>PS].type==PT_BRMT){
                        if ((parts[r>>PS].ctype != PT_BRMT)||(parts[i].y<parts[r>>PS].y)){
                            ...
                            parts[r>>PS].tmp = (((parts[i].y)-(parts[r>>PS].y))/10)*(rand()%5+10/10);
                ...
                if (x+rx>=0 && y+ry>0 && x+rx<XRES && y+ry<YRES && (rx || ry)){
                    ...
                    if (parts[r>>PS].type==PT_IFIL){
                        if ((parts[r>>PS].ctype != PT_IFIL)||(parts[i].y<parts[r>>PS].y)){
                            ...
                            parts[r>>PS].vx = parts[r>>PS].tmp - parts[r>>PS].tmp - parts[r>>PS].tmp;
                            parts[r>>PS].tmp = (((parts[i].y)-(parts[r>>PS].y))/10)*(rand()%5+20/20);
                            parts[r>>PS].vy = parts[r>>PS].tmp - parts[r>>PS].tmp - parts[r>>PS].tmp;
                        }else{
                            parts[r>>PS].tmp = (((parts[i].x)-(parts[r>>PS].x))/280)*(rand()%5+20/20);
                            parts[r>>PS].vx = parts[r>>PS].tmp - parts[r>>PS].tmp - parts[r>>PS].tmp;
                            parts[r>>PS].tmp = (((parts[i].y)-(parts[r>>PS].y))/280)*(rand()%5+20/20);
                            parts[r>>PS].vy = parts[r>>PS].tmp - parts[r>>PS].tmp - parts[r>>PS].tmp;
                        }
                    }
                }
