	...
	gridSize(0)
{
	...
	renderModePresets[0].Name = L"Alternative Velocity Display";
	...
	renderModePresets[1].Name = L"Velocity Display";
	...
	renderModePresets[2].Name = L"Pressure Display";
	...
	renderModePresets[3].Name = L"Persistent Display";
	...
	renderModePresets[4].Name = L"Fire Display";
	...
	renderModePresets[5].Name = L"Blob Display";
	...
	renderModePresets[6].Name = L"Heat Display";
	...
	renderModePresets[7].Name = L"Fancy Display";
