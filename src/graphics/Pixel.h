...
constexpr RGB RGB::AddFire(RGB other, int fireAlpha) const {
	return RGB(
...
constexpr RGB RGB::Inverse() const {
...
constexpr pixel RGB::Pack() const {
	return Red << 16 | Green << 8 | Blue;
}

constexpr RGB RGBA::NoAlpha() const {
	return RGB(Red, Green, Blue);
}

constexpr pixel RGBA::Pack() const {
