...
const BuiltinGOL builtinGol[NGOL] = {
	...
	{ "GOL",  GT_GOL , 0x0080C, PIXPACK(0x0CAC00), NGT_GOL,  String("Game Of Life: Begin 3/Stay 23") },
	{ "HLIF", GT_HLIF, 0x0480C, PIXPACK(0xFF0000), NGT_HLIF, String("High Life: B36/S23") },
	{ "ASIM", GT_ASIM, 0x038F0, PIXPACK(0x0000FF), NGT_ASIM, String("Assimilation: B345/S4567") },
	{ "2x2",  GT_2x2 , 0x04826, PIXPACK(0xFFFF00), NGT_2x2,  String("2x2: B36/S125") },
	{ "DANI", GT_DANI, 0x1C9D8, PIXPACK(0x00FFFF), NGT_DANI, String("Day and Night: B3678/S34678") },
	{ "AMOE", GT_AMOE, 0x0A92A, PIXPACK(0xFF00FF), NGT_AMOE, String("Amoeba: B357/S1358") },
	{ "MOVE", GT_MOVE, 0x14834, PIXPACK(0xFFFFFF), NGT_MOVE, String("'Move' particles. Does not move things.. it is a life type: B368/S245") },
	{ "PGOL", GT_PGOL, 0x0A90C, PIXPACK(0xE05010), NGT_PGOL, String("Pseudo Life: B357/S238") },
	{ "DMOE", GT_DMOE, 0x1E9E0, PIXPACK(0x500000), NGT_DMOE, String("Diamoeba: B35678/S5678") },
	{ "34",   GT_34  , 0x01818, PIXPACK(0x500050), NGT_34,   String("34: B34/S34") },
	{ "LLIF", GT_LLIF, 0x03820, PIXPACK(0x505050), NGT_LLIF, String("Long Life: B345/S5") },
	{ "STAN", GT_STAN, 0x1C9EC, PIXPACK(0x5000FF), NGT_STAN, String("Stains: B3678/S235678") },
	{ "SEED", GT_SEED, 0x00400, PIXPACK(0xFBEC7D), NGT_SEED, String("Seeds: B2/S") },
	{ "MAZE", GT_MAZE, 0x0083E, PIXPACK(0xA8E4A0), NGT_MAZE, String("Maze: B3/S12345") },
	{ "COAG", GT_COAG, 0x189EC, PIXPACK(0x9ACD32), NGT_COAG, String("Coagulations: B378/S235678") },
	{ "WALL", GT_WALL, 0x1F03C, PIXPACK(0x0047AB), NGT_WALL, String("Walled cities: B45678/S2345") },
	{ "GNAR", GT_GNAR, 0x00202, PIXPACK(0xE5B73B), NGT_GNAR, String("Gnarl: B1/S1") },
	{ "REPL", GT_REPL, 0x0AAAA, PIXPACK(0x259588), NGT_REPL, String("Replicator: B1357/S1357") },
	{ "MYST", GT_MYST, 0x139E1, PIXPACK(0x0C3C00), NGT_MYST, String("Mystery: B3458/S05678") },
	{ "LOTE", GT_LOTE, 0x48938, PIXPACK(0xFF0000), NGT_LOTE, String("Living on the Edge: B37/S3458/4") },
	{ "FRG2", GT_FRG2, 0x20816, PIXPACK(0x00FF00), NGT_FRG2, String("Like Frogs rule: B3/S124/3") },
	{ "STAR", GT_STAR, 0x98478, PIXPACK(0x0000FF), NGT_STAR, String("Like Star Wars rule: B278/S3456/6") },
	{ "FROG", GT_FROG, 0x21806, PIXPACK(0x00AA00), NGT_FROG, String("Frogs: B34/S12/3") },
	{ "BRAN", GT_BRAN, 0x25440, PIXPACK(0xCCCC00), NGT_BRAN, String("Brian 6: B246/S6/3" )}
};
