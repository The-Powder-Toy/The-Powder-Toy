...
wall_type * LoadWalls(int & wallCount)
{
	wall_type wtypes[] =
	{
		{PIXPACK(0x808080), PIXPACK(0x000000), 0, Renderer::WallIcon, TEXT_WALL_ERASE_NAME,	"DEFAULT_WL_ERASE",	L"Erases walls."},
		{PIXPACK(0xC0C0C0), PIXPACK(0x101010), 0, Renderer::WallIcon, TEXT_WALL_CNDTW_NAME,	"DEFAULT_WL_CNDTW",	L"Blocks everything. Conductive."},
		{PIXPACK(0x808080), PIXPACK(0x808080), 0, Renderer::WallIcon, TEXT_WALL_EWALL_NAME,	"DEFAULT_WL_EWALL",	L"E-Wall. Becomes transparent when electricity is connected."},
		{PIXPACK(0xFF8080), PIXPACK(0xFF2008), 1, Renderer::WallIcon, TEXT_WALL_DTECT_NAME,	"DEFAULT_WL_DTECT",	L"Detector. Generates electricity when a particle is inside."},
		{PIXPACK(0x808080), PIXPACK(0x000000), 0, Renderer::WallIcon, TEXT_WALL_STRM_NAME,	"DEFAULT_WL_STRM",	L"Streamline. Set start point of a streamline."},
		{PIXPACK(0x8080FF), PIXPACK(0x000000), 1, Renderer::WallIcon, TEXT_WALL_FAN_NAME,	"DEFAULT_WL_FAN",	L"Fan. Accelerates air. Use the line tool to set direction and strength."},
		{PIXPACK(0xC0C0C0), PIXPACK(0x101010), 2, Renderer::WallIcon, TEXT_WALL_LIQD_NAME,	"DEFAULT_WL_LIQD",	L"Allows liquids, blocks all other particles. Conductive."},
		{PIXPACK(0x808080), PIXPACK(0x000000), 1, Renderer::WallIcon, TEXT_WALL_ABSRB_NAME,	"DEFAULT_WL_ABSRB",	L"Absorbs particles but lets air currents through."},
		{PIXPACK(0x808080), PIXPACK(0x000000), 3, Renderer::WallIcon, TEXT_WALL_WALL_NAME,	"DEFAULT_WL_WALL",	L"Basic wall, blocks everything."},
		{PIXPACK(0x3C3C3C), PIXPACK(0x000000), 1, Renderer::WallIcon, TEXT_WALL_AIR_NAME,	"DEFAULT_WL_AIR",	L"Allows air, but blocks all particles."},
		{PIXPACK(0x575757), PIXPACK(0x000000), 1, Renderer::WallIcon, TEXT_WALL_POWDR_NAME,	"DEFAULT_WL_POWDR",	L"Allows powders, blocks all other particles."},
		{PIXPACK(0xFFFF22), PIXPACK(0x101010), 2, Renderer::WallIcon, TEXT_WALL_CNDTR_NAME,	"DEFAULT_WL_CNDTR",	L"Conductor. Allows all particles to pass through and conducts electricity."},
		{PIXPACK(0x242424), PIXPACK(0x101010), 0, Renderer::WallIcon, TEXT_WALL_EHOLE_NAME,	"DEFAULT_WL_EHOLE",	L"E-Hole. absorbs particles, releases them when powered."},
		{PIXPACK(0x579777), PIXPACK(0x000000), 1, Renderer::WallIcon, TEXT_WALL_GAS_NAME,	"DEFAULT_WL_GAS",	L"Allows gases, blocks all other particles."},
		{PIXPACK(0xFFEE00), PIXPACK(0xAA9900), 4, Renderer::WallIcon, TEXT_WALL_GRVTY_NAME,	"DEFAULT_WL_GRVTY",	L"Gravity wall. Newtonian Gravity has no effect inside a box drawn with this."},
		{PIXPACK(0xFFAA00), PIXPACK(0xAA5500), 4, Renderer::WallIcon, TEXT_WALL_ENRGY_NAME,	"DEFAULT_WL_ENRGY",	L"Allows energy particles, blocks all other particles."},
		{PIXPACK(0xDCDCDC), PIXPACK(0x000000), 1, Renderer::WallIcon, TEXT_WALL_NOAIR_NAME,	"DEFAULT_WL_NOAIR",	L"Allows all particles, but blocks air."},
		{PIXPACK(0x808080), PIXPACK(0x000000), 0, Renderer::WallIcon, TEXT_WALL_ERASEA_NAME,"DEFAULT_WL_ERASEA",L"Erases walls, particles, and signs."},
	};
