...
void Element::Element_PRGL()
{
	Identifier = "DEFAULT_PT_PRGL";
	Name = "PRGL";
	...
	HeatConduct = 150;
	Description = "Pressure Resistant Glass. Meltable. Shatters under pressure, and refracts photons.";
