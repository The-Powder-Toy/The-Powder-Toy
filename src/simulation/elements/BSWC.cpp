...
void Element::Element_BSWC()
{
	Identifier = "DEFAULT_PT_BSWC";
	Name = "BSWC";
	Colour = PIXPACK(0x195B11);
	MenuVisible = 1;
	MenuSection = SC_ELEC;
	Enabled = 1;
	...
	HeatConduct = 251;
	Description = "Only conducts when switched on. (PSCN switches on, NSCN switches off.) it is also breakable.";
