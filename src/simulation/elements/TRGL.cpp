...
void Element::Element_GLAS()
{
	...
	HeatConduct = 150;
	Description = "Temperature Resistant Glass. Meltable. Shatters under slight amounts of pressure, and refracts photons.";
