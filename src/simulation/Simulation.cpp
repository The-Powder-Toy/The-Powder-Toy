...
void Simulation::AddPos(Simulation& sim, float x, float y, float dx, float dy, float& outx, float& outy)
{
	switch (sim.edgeMode)
	{
	case EDGE_LOOP:
...
void Simulation::DiffPos(Simulation& sim, float fromX, float fromY, float toX, float toY, float& outx, float& outy)
{
	switch (sim.edgeMode)
	{
	case EDGE_LOOP:
