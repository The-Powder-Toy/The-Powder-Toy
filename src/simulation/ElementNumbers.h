...
ELEMENT_DEFINE(FPTC, 187);
ELEMENT_DEFINE(FNTC, 188);
ELEMENT_DEFINE(CLNT, 189);
ELEMENT_DEFINE(LED, 190);
ELEMENT_DEFINE(TIMC, 191);
ELEMENT_DEFINE(FUEL, 192);
ELEMENT_DEFINE(LITH, 193);
ELEMENT_DEFINE(DMRN, 194);
ELEMENT_DEFINE(PINV, 195);
ELEMENT_DEFINE(VSNS, 196);
ELEMENT_DEFINE(WALL, 197);
ELEMENT_DEFINE(COND, 198);
ELEMENT_DEFINE(QGPP, 199);
ELEMENT_DEFINE(UVRD, 200);
ELEMENT_DEFINE(SUN,  201);
ELEMENT_DEFINE(TMPS, 202);
ELEMENT_DEFINE(PHOS, 203);
ELEMENT_DEFINE(PTNM, 204);
ELEMENT_DEFINE(CMNT, 205);
ELEMENT_DEFINE(NTRG, 206);
ELEMENT_DEFINE(PRMT, 207);
ELEMENT_DEFINE(CLUD, 208);
ELEMENT_DEFINE(BEE, 209); 
ELEMENT_DEFINE(ECLR, 210);
ELEMENT_DEFINE(SLCN, 211);
ELEMENT_DEFINE(C16, 212);
ELEMENT_DEFINE(CWIR, 213);
