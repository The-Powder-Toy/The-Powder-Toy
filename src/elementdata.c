...
part_type ptypes[PT_NUM] =
{
	...
	{"PROT",	PIXPACK(0x990000),	0.0f,	0.00f * CFDS,	1.00f,	1.00f,	-0.99f,	0.0f,	0.00f,	0.000f	* CFDS,	0,	0,		0,	0,	0,	1,	1,	-1,		SC_NUCLEAR,		R_TEMP+0.0f+273.15f,	51,	"Protons. Transfer heat to materials.", ST_GAS, TYPE_ENERGY|PROP_LIFE_DEC|PROP_LIFE_KILL_DEC, &update_PROT, &graphics_PROT},
