	...
	onKeyReleaseFunction(0)
{
	...
	public:
		...
		void OnKeyPress(int key, Uint16 character, bool shift, bool ctrl, bool alt) override { luaWindow->triggerOnKeyPress(key, character, shift, ctrl, alt); }
		void OnKeyRelease(int key, Uint16 character, bool shift, bool ctrl, bool alt) override { luaWindow->triggerOnKeyRelease(key, character, shift, ctrl, alt); }
	};
