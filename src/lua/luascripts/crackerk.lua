...
local creditstxt1 = Label:new(80,-20,80, 60, "Welcome to the Cracker1000's script version 2.0")
...
local wiki  =  Button:new(203,28,75,30,"Wiki", "Element wiki!")

local bare = Button:new(203,60,75,30,"Hidden Elem.", "Toggle hidden elements.")
local barye = Button:new(293,60,80,20,"Show", "Shows hidden elements")
local barne = Button:new(293,80,80,20,"Hide", "Hides elements")

local mp = Button:new(203,92,75,30,"Theme", "Changes game's theme")
...
local bg = Button:new(203,124,75,30,"Backgrounds", "Sets different backgrounds.")
